...
node_url = "http://159.138.123.135:9904"

frok = "00000001cf57212c59faebd3409ae04291c7628cb0d7de8897682a9ac587627e"
...
vin = obj["result"]["addresses"][0]["unspents"]
if len(vin) == 0:
    print("没有金额了")
    exit()
max_utxo = {"amount":0}
